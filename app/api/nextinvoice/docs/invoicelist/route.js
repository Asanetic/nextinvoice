...
//--- End invoices inputs array --//
    ...
    if (InvoicelistFormAction === "add_invoices") 
    {
      ...
      InvoicelistInputsArr.invoice_id = newId;
      
      // Insert into table Invoicelist
      const result = await mosySqlInsert("invoices", InvoicelistInputsArr, body);
    ...
    if (InvoicelistFormAction === "update_invoices") {
      ...
      const result = await mosySqlUpdate("invoices", InvoicelistInputsArr, body, `primkey='${invoices_uptoken_value}'`);
