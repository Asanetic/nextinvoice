          ...
          <form onSubmit={postMessagetemplatesFormData} encType="multipart/form-data" id="message_templates_profile_form">
            ...
            <>{showNavigationIsle && (<div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              ...
              {paramMessagetemplatesUptoken && (
                ...
                type="button"
                className="medium_btn border border-danger text-danger p-2 ml-3 mb-3 hive_profile_nav_del_btn"
                onClick={() =>popDeleteDialog(paramMessagetemplatesUptoken, {childStateSetters: stateItemSetters, parentStateSetters: parentStateSetters} , router)}
              ...
              {paramMessagetemplatesUptoken && (
                ...
                <AddNewButton link="./profile" label=" Create template " icon="plus-circle" />
              ...
              <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
                <div className="col-md-12 row justify-content-center p-0 m-0">
                  ...
                  <div className="col-md-12 text-center">
                    <SubmitButtons tblName="message_templates" extraClass="optional-custom-class" />
                  </div>
                </div></div>
                {/*    Input cells section isle      */}
              </div>
