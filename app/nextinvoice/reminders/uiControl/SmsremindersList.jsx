...
//data
import { loadSmsremindersListData, popDeleteDialog, InteprateSmsremindersEvent  } from '../dataControl/SmsremindersRequestHandler';
...
export default function SmsremindersList({ dataIn = {}, dataOut = {} }) {
  
  //incoming data in from parent
  const {
    customQueryStr = "",
    customProfilePath="../reminders/sms",
  ...
  useEffect(() => {
    ...
    loadSmsremindersListData(customQueryStr, stateItemSetters);
  ...
  return (
    ...
    <div className="col-md-12 bg-white p-0 main_list_container  " style={{marginTop: "0px", paddingBottom: "0px"}}>
      <form method="post" onSubmit={()=>{mosyFilterUrl({tableName:"messaging", keyword:stateItem.smsremindersQuerySearchStr})}} encType="multipart/form-data">
      
      {showDataControlSections && (<div className="row justify-content-end col-md-12 text-right pt-3 pb-3 data_list_section ml-0 mr-0 mb-3 border-bottom pr-0 pl-0" id="">
        <div className="col-md-6 p-0 text-left pt-3 hive_list_title">
          <h6 className="text-muted"><b> Sms Reminders </b></h6>
        </div>
        <div className="col-md-6 p-0 text-right hive_list_search_tray">
          <input type="text" id="txt_messaging" name="txt_messaging" className="custom-search-input form-control" placeholder="Search in Sms Reminders "
          onChange={(e) => stateItemSetters.setSmsremindersQuerySearchStr(e.target.value)}
          />
        ...
        <div className="row justify-content-end m-0 p-0 col-md-12 hive_list_action_btn_tray" id="">
          ...
          <div className="col-md-12 p-0 hive_list_nav_right_ribbon" id="">
            ...
            <a href="smslist" className="medium_btn border border_set btn-white hive_list_nav_refresh ml-3"><i className="fa fa-refresh mr-1 "></i> Refresh </a>
      ...
      <div className="row justify-content-center m-0 p-0 col-md-12" id="">
        {stateItem.smsremindersLoading ? (
          <h5 className="col-md-12 text-center p-3 mb-5 text-muted"><i className="fa fa-spinner fa-spin"></i> Loading Sms Reminders ...</h5>
        ) : stateItem.smsremindersListData.length > 0 ? (
          stateItem.smsremindersListData.map((listmessaging_result, index) => (
        ...
        <MosyPaginationUi
        tblName="messaging"
        totalPages={stateItem.smsremindersListPageCount}
