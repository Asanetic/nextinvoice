...
//data
import { loadInvoicelistListData, popDeleteDialog, InteprateInvoicelistEvent  } from '../dataControl/InvoicelistRequestHandler';
...
//export list
export default function InvoicelistList({ dataIn = {}, dataOut = {} }) {
  ...
  useEffect(() => {
    ...
    loadInvoicelistListData(customQueryStr, stateItemSetters);
  ...
  return (
    ...
    <div className="col-md-12 bg-white p-0 main_list_container  " style={{marginTop: "0px", paddingBottom: "0px"}}>
      <form method="post" onSubmit={()=>{mosyFilterUrl({tableName:"invoices", keyword:stateItem.invoicelistQuerySearchStr})}} encType="multipart/form-data">
      
      {showDataControlSections && (<div className="row justify-content-end col-md-12 text-right pt-3 pb-3 data_list_section ml-0 mr-0 mb-3 border-bottom pr-0 pl-0" id="">
        <div className="col-md-6 p-0 text-left pt-3 hive_list_title">
          <h6 className="text-muted"><b> Invoice list </b></h6>
        </div>
        <div className="col-md-6 p-0 text-right hive_list_search_tray">
          <input type="text" id="txt_invoices" name="txt_invoices" className="custom-search-input form-control" placeholder="Search in Invoice list "
          onChange={(e) => stateItemSetters.setInvoicelistQuerySearchStr(e.target.value)}
          />
      ...
      <div className="table-responsive  data-tables bg-white bottom_tbl_handler">
        ...
        <div className="text-left m-0 p-0 col-md-12">
          ...
          onClick={() => {mosyPrintToPdf({elemId : "invoices_print_card", defaultTitle:"Invoice list"})}}
          >
          <i className="fa fa-print "></i> Print List
        </div>
        <div className="cpointer p-2 ml-2 badge rounded border border_set badge-whte mb-3 tbl_print_to_excel_btn"
        
        onClick={() => exportTableToExcel("invoices_data_table", "Invoice list.xlsx")}
        >
    ...
    <div className="col-md-12 " id="invoices_print_card">
      <table className="table table-hover  text-left printTarget" id="invoices_data_table">
        ...
        <tbody>
          {stateItem.invoicelistLoading ? (
            <tr>
              <th scope="col">#</th>
              <td colSpan="11" className="text-muted">
                <h5 className="col-md-12 text-center p-3 mb-5 text-muted"><i className="fa fa-spinner fa-spin"></i> Loading Invoice list ...</h5>
              </td>
            </tr>
          ) : stateItem.invoicelistListData?.length > 0 ? (
            stateItem.invoicelistListData.map((listinvoices_result, index) => (
