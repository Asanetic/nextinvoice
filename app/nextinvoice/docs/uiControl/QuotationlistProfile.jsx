          ...
          <form onSubmit={postQuotationlistFormData} encType="multipart/form-data" id="invoices_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                ...
                {paramQuotationlistUptoken && (
                  ...
                  onClick={() =>popDeleteDialog(paramQuotationlistUptoken, {childStateSetters: stateItemSetters, parentStateSetters: parentStateSetters} )}
            ...
            <>{showNavigationIsle && (<div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              <div className="col-md-4 text-left p-0 hive_profile_nav_back_to_list_tray" id="">
                ...
                <Link href="./quotations" className="text-info hive_profile_nav_back_to_list"><i className="fa fa-arrow-left"></i> Back to list</Link>
