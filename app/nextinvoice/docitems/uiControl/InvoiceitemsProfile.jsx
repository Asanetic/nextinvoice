...
export default function InvoiceitemsProfile({ dataIn = {}, dataOut = {} }) {
  ...
  function postInvoiceitemsFormData(e) {
    ...
    inteprateInvoiceitemsFormAction(e, stateItemSetters).then(response=>{
      ...
      mosyScrollTo("InvoiceitemsProfileTray")
      closeMosyModal()
          ...
          <form onSubmit={postInvoiceitemsFormData} encType="multipart/form-data" id="invoice_items_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              <div className="col m-0 p-0 pb-3">
                {invoice_itemsNode?.primkey ? (  <span> Item / {invoice_itemsNode?.item_name || ""}</span> ) :(<span> Add item </span>)}
              </div>
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                ...
                {paramInvoiceitemsUptoken && (
                  ...
                  onClick={() =>popDeleteDialog(paramInvoiceitemsUptoken, {childStateSetters: stateItemSetters, parentStateSetters: parentStateSetters} )}
            ...
            <>{showNavigationIsle && (<div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              ...
              {paramInvoiceitemsUptoken && (
                ...
                type="button"
                className="medium_btn border border-danger text-danger p-2 ml-3 mb-3 hive_profile_nav_del_btn"
                onClick={() =>popDeleteDialog(paramInvoiceitemsUptoken, {childStateSetters: stateItemSetters, parentStateSetters: parentStateSetters} , router)}
