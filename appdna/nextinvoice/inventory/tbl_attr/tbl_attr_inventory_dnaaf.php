...
$custom_next_js_query_line_cols=[
  "totals"=>[
    "function" => 'row?.quantity*row?.rate',
    "args"=>[],
    "return"=>"data_res"],
...
//1. invoices //"primkey" , "invoice_id" , "invoice_no" , "date_created" , "date_due" , "paid_status" , "created_by" , "name" , "invoice_stage" , "remark" , "client_id" , "paid_on" , "supplier_id" , "invoice_type" , "account_affect" , "inv_no_int" , "invoice_key" , "client_name" , "client_tel" , "client_email" , "invoice_amount" , "hive_site_id" , "hive_site_name" , "vendor_headers" , "client_headers" , "vendor_name" , "currency" , "discount" , "amount_paid" , "date_paid" , "ref_no" , "quotation" , "date_updated" , "folder" ,


//1. invoice_items //"primkey" , "record_id" , "invoice_id" , "item_id" , "item_name" , "quantity" , "rate" , "tax" , "discount" , "date_created" , "account_context" , "account_name" , "item_key" , "stock_type" , "invoice_edit_key" , "selling_price" , "sale_state" , "remaining_qty" , "add_to_stock" , "item_remark" , "hive_site_id" , "hive_site_name" ,
...
//1. invoice_items //"primkey" , "record_id" , "invoice_id" , "item_id" , "item_name" , "quantity" , "rate" , "tax" , "discount" , "date_created" , "account_context" , "account_name" , "item_key" , "stock_type" , "invoice_edit_key" , "selling_price" , "sale_state" , "remaining_qty" , "add_to_stock" , "item_remark" , "hive_site_id" , "hive_site_name" ,
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "invoice_items"=>[ 
                    "Item details"=>["item_id","quantity","rate","totals","item_remark"],
             ]
    ...
    "hidden_inputs"=>["date_created","qty"],
    
    //==============================================   print_tables tables with print buttons
    "print_tables"=>["invoices"],
    
    //==============================================   ///skip  these columns on the profile page 
    "skip_cols_profile"=>["quantity" , "discount" , "date_created" , "account_context" , "account_name" , "item_key" , "stock_type" , "invoice_edit_key" , "selling_price" , "sale_state" , "tax" , "add_to_stock" , "hive_site_id" , "hive_site_name" ],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["quantity" , "discount" , "date_created" , "account_context" , "account_name" , "item_key" , "stock_type" , "invoice_edit_key" , "selling_price" , "sale_state" , "tax" , "add_to_stock" , "hive_site_id" , "hive_site_name"],
    ...
    "dynamic_drop_down_array"=>['folder',"currency"],
    ...
    "rename_cols_array"=>["totals"=>"Row totals:col-md-4","reate"=>"Rate:c","quantity"=>"Qty:col-md-4",'item_remark'=>'Description',"item_id"=>"Item name:col-md-12","invoice_id"=>"Invoice No."],
    ...
    "new_label_buttons_arr"=>['inventory'=>'plus-circle:Add products / services  : Item profile  / {{item_name}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "custom_profile_col_data"=>["totals"=>"{(Number(invoice_itemsNode?.rate)*Number(invoice_itemsNode?.quantity))}"],
    
    "custom_profile_default_data"=>["invoice_type"=>'{`invoice`}', "totals"=>"{(Number(invoice_itemsNode?.rate)*Number(invoice_itemsNode?.quantity))}", "invoice_kkno"=>'{`Inv/${magicRandomStr()}`}'],
    
    //=============================================        on the ui , these columns connect values from other tables
    "connection_cols"=>[
      'item_id'=>"invoice_items:record_id:item_summary:/api/nextinvoice/docitems/invoiceitemsgroup: 
      {
      ...
      "invoice_id"=>"invoices:invoice_id:invoice_no:/api/nextinvoice/docs/invoicelist"
    ],
