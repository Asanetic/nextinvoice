...
$custom_next_js_query_line_cols=[
  "invoice_key"=>[
    "function" => 'await mosyFlexQuickSel("invoices", "primkey",`where invoice_id =\'${row?.invoice_id}\'`,"r")',
    "args"=>[],
...
//1. invoice_payments //"primkey" , "record_id" , "invoice_id" , "date_paid" , "amount_paid" , "balance" , "ref_no" , "payment_mode" , "remark" , "hive_site_id" , "hive_site_name" , "invoice_no" ,  
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "skip_cols_profile"=>["balance", "hive_site_id" , "hive_site_name" , "invoice_no", "invoice_key"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["balance", "hive_site_id" , "hive_site_name" , "invoice_no", "invoice_key"],
        
    ///=============================================   these columns diplays running balance amount 
    "running_bal_col_tbl"=>["balance", "hive_site_id" , "hive_site_name" , "invoice_no"],    
    //sample 
    ...
    "dynamic_drop_down_array"=>['payment_mode',"phone_number"],
    ...
    "date_columns"=>['date_paid',"column_name2..."],
    ...
    "rename_cols_array"=>['invoice_id'=>'Invoice number '],
    ...
    "new_label_buttons_arr"=>['invoice_payments'=>'plus-circle: Add payments : Payment {{ref_no}}'],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>['invoice_id'=>'invoices:invoice_id:invoice_no:/api/nextinvoice/docs/invoicelist'],
