...
//messaging //"primkey" , "messageid" ,//messaging //"primkey" , "messageid" , "receiver_contacts" , "reciver_names" , "message_type" , "site_id" , "group_name" , "message_date" , "sent_state" , "msg_read_state" , "subject" , "message_label" , "message_details" , "sms_cost" , "page_count" , "hive_site_id" , "hive_site_name" , "custom_dictionary" , "message_signature" ,,

//message_templates //"primkey" , "record_id" , "template_name" , "message_subject" , "message_template" , "template_code" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'message_templates' => ['primkey','record_id', "template_name","template_code",'message_template', 'message_details','date_booked'],
    ...
    "skip_cols_profile"=>["message_subject" , "site_id" , "group_name" , "msg_read_state" , "message_label" , "sms_cost" , "page_count" , "hive_site_id" , "hive_site_name" , "message_signature"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["message_subject","hive_site_id" , "hive_site_name" , ],
    ...
    "textarea_array"=>['message_template',"column_name2..."],
    ...
    "datetime_columns"=>['regdate','message_date'],
    
    //============================================        on the ui , rename these column lables to the new names indicated ...
    "rename_cols_array"=>['ref_number'=>'Document no'],
    ...
    "new_label_buttons_arr"=>['message_templates'=>'plus-circle: Create template : Template / {{template_code}}'],
    //sample 
