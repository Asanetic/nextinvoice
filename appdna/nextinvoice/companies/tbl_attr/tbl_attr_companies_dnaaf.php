...
//1. companies //"primkey" , "company_id" , "business_no" , "name" , "mobile" , "email" , "business_name" , "location" , "specialty" , "remark" , "logo" , "bank_name" , "account_no" , "pin_no" , "swort_code" , "hive_site_id" , "hive_site_name" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'companies' => ['primkey','company_id', "business_name",'mobile', 'email','location','date_booked'],
    ...
    "skip_cols_profile"=>["business_no","name","bank_name","account_no","pin_no" , "swort_code" , "hive_site_id" , "hive_site_name"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["business_no","name","bank_name","account_no","pin_no" , "swort_code" , "hive_site_id" , "hive_site_name"],
    ...
    "static_drop_down_array"=>['emakil'=>"value1,value2,value3","column_name2..."=>"value1,value2,value3"],
    //sample 
    ...
    "dynamic_drop_down_array"=>['specialty',"location"],
    ...
    "new_label_buttons_arr"=>['companies'=>'plus-circle:Add business : Company / {{business_name}}'],
    //sample 
