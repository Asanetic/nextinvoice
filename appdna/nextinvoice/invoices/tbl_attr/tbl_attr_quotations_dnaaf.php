...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "invoices"=>[ 
                    "Quotation headers"=>["client_id","vendor_name","client_headers","vendor_headers"],
                    "Quotation letter"=>["footnote"],
                    "Document settings"=>["invoice_no","remark","currency","discount","","folder","date_due", "client_tel","client_email","invoice_type"],
             ]
    ...
    "skip_cols_list"=>["invoice_amount","amount_paid","paid_status" , "created_by" , "name" , "invoice_stage"   , "paid_on" , "supplier_id" , "account_affect" , "inv_no_int" , "invoice_key" , "client_name"  , "hive_site_id" , "hive_site_name"  , "date_paid" , "ref_no" , "quotation" , "date_updated","vendor_headers","client_headers" , "vendor_name", "footnote","client_tel","client_email", "invoice_type" ],
    ...
    "rename_cols_array"=>['client_id'=>'Client name',"invoice_no"=>"Quotation Number","footnote"=>"Quotation letter:col-md-12"],
    ...
    "new_label_buttons_arr"=>['invoices'=>'plus-circle:Create quotation : Quotation | {{invoice_no}} '],
    //sample 
