...
//clients //"primkey" , "client_id" , "client_name" , "client_email" , "client_tel" , "client_location" , "client_photo" , "gender" , "date_registered" , "password" , "admin_id" , "hive_site_id" , "hive_site_name" ,
    
    //segment inputs into groups eg user details , user payments , user subscriptions etc  
    "form_input_segmentation_arr"=>[
          //sample 
          "invoices"=>[ 
                    "Invoice headers"=>["client_id","vendor_name","client_headers","vendor_headers"],
                    "Document settings"=>["invoice_no","remark","currency","discount","","folder","date_due", "client_tel","client_email","invoice_type","footnote"],
             ]
...
//clients //"primkey" , "client_id" , "client_name" , "client_email" , "client_tel" , "client_location" , "client_photo" , "gender" , "date_registered" , "password" , "admin_id" , "hive_site_id" , "hive_site_name" ,
    ...
    "skip_cols_profile"=>[ "password" , "admin_id" , "hive_site_id" , "hive_site_name","gender","client_photo"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>[ "password" , "admin_id" , "hive_site_id" , "hive_site_name","gender","client_photo"],
    ...
    "static_drop_down_array"=>['gender'=>"Sir,value2,value3","column_name2..."=>"value1,value2,value3"],
    //sample 
    ...
    "dynamic_drop_down_array"=>['folder',"client_location"],
    ...
    "title_columns"=>['e','column_name2...'],

    //==============================================      | on the profile page, these columns are dates Y-m-d
    "date_columns"=>['date_registered',"date_due"],
    ...
    "new_label_buttons_arr"=>['clients'=>'plus-circle:Create client account : Accounts / {{client_name}} '],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "custom_profile_default_data"=>["invoice_type"=>'{`invoice`}', "invoice_kkno"=>'{`Inv/${magicRandomStr()}`}'],
    
    //=============================================        on the ui , these columns connect values from other tables
    "connection_cols"=>[
      'client_id'=>"clients:client_id:client_name:/api/nextinvoice/clients/clientlist: 
      {
