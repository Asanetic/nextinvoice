...
//system_users //"primkey" , "user_id" , "name" , "email" , "tel" , "login_password" , "ref_id" , "regdate" , "user_no" , "user_pic" , "user_gender" , "last_seen" , "about" , "hive_site_id" , "hive_site_name" , "auth_token" , "token_status" , "token_expiring_in" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "skip_cols_profile"=>["ref_id" , "regdate" , "user_no" , "user_gender" , "last_seen" , "about" , "hive_site_id" , "hive_site_name" , "auth_token" , "token_status" , "token_expiring_in"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>[ "ref_id" , "regdate" , "user_no" , "user_gender" , "last_seen" , "about" , "hive_site_id" , "hive_site_name" , "auth_token" , "token_status" , "token_expiring_in","password"],
    ...
    "static_drop_down_array"=>['emaildd'=>"value1,value2,value3","column_name2..."=>"value1,value2,value3"],
    //sample 
