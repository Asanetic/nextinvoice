...
//lead_followup //"primkey" , "record_id" , "lead_id" , "followup_type" , "followup_date" , "status" , "remark" , "potential" , "stage" , "hive_site_id" , "hive_site_name" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "desired_column_order"=>[
        ...
        'lead_followup' => ['primkey','record_id', "lead_id",'followup_type', 'followup_date','status','potential',"stage"],
    ...
    "dynamic_drop_down_array"=>['followup_type',"stage","potential","status"],
    ...
    "date_columns"=>['followup_date',"column_name2..."],
    ...
    "rename_cols_array"=>['remark'=>'Notes', "lead_id"=>"Client name"],
    ...
    "new_label_buttons_arr"=>['lead_followup'=>'plus-circle: Add followup : Follow up details / {{_leads_list_name_lead_id}} '],
    //sample 
  ...
  "data_behaviour"=>[
    ...
    "connection_cols"=>['lead_id'=>'leads_list:record_id:name:/api/nextinvoice/leads_list/leadslist'],
