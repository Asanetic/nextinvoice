...
//quick_notes //"primkey" , "record_id" , "note_title" , "note_date" , "note_details" , "note_tag" , "folder_name" , "dateupdated" , "hive_site_id" , "hive_site_name" ,
  ...
  "page_layout"=>[
   ...
   //quick_notes //"primkey" , "record_id" , "note_title" , "note_date" , "note_details" , "note_tag" , "folder_name" , "dateupdated" , "hive_site_id" , "hive_site_name" ,
    ...
    "desired_column_order"=>[
        ...
        'quick_notes' => ['primkey','record_id', "note_title",'note_tag', 'folder_name','note_details'],
    ...
    "hidden_inputs"=>["note_date","dateupdated"],
    
    //==============================================   print_tables tables with print buttons
    "print_tables"=>["clients"],
    
    //==============================================   ///skip  these columns on the profile page 
    "skip_cols_profile"=>["dateupdated","note_date","hive_site_id" , "hive_site_name"],
        
    ///=============================================   skip  these columns on the list page 
    "skip_cols_list"=>["hive_site_id" , "hive_site_name","dateupdated","note_date","hive_site_id" , "hive_site_name"],
    ...
    //============================================    on the profile page for these columns use textarea component
    "content_editable"=>['note_details',"column_name2..."],
    ...
    "dynamic_drop_down_array"=>['note_tag',"folder_name"],
    ...
    "date_columns"=>['dateupdated',"note_date"],
    ...
    "rename_cols_array"=>['note_details'=>'Content', "note_title"=>"Title", "note_tag"=>"Tag / category"],
    ...
    "new_label_buttons_arr"=>['quick_notes'=>'file-text:New document : {{note_title}}'],
    //sample 
