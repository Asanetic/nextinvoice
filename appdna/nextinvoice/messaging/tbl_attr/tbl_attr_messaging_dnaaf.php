...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "skip_cols_profile"=>["message_type" , "site_id" , "group_name" , "msg_read_state" , "message_label" , "sms_cost" , "page_count" , "hive_site_id" , "hive_site_name" , "message_signature"],
    ...
    "textarea_array"=>['message_details',"column_name2..."],
    ...
    "new_label_buttons_arr"=>['messaging'=>'edit:New message : Message details'],
    //sample 
