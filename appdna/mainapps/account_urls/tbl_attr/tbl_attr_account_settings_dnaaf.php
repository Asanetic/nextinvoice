...
//leads_list //"primkey" , "record_id" , "name" , "tel" , "email" , "lead_date" , "source" , "campaign" , "cost" , "potential" , "stage" , "tag" , "remark" , "hive_site_id" , "hive_site_name" ,
...
$novanest_module_ui_blueprint_=[
  ...
  "page_layout"=>[
    ...
    "form_input_segmentation_arr"=>[
          //sample 
          "leads_list"=>[ 
                    "Basic info"=>["name","tel","email","lead_date"],
                    "Source and status"=>["tag","source","campaign","cost","potential","stage","remark"],
             ]
    ...
    "textarea_array"=>['description',"column_name2..."],
    
    //============================================    on the profile page for these columns use textarea component
    "content_editable"=>['remark',"column_name2..."],
    
    //============================================    on the profile page for these columns use drop down with these values component
    "static_drop_down_array"=>['url_name'=>"sms_api,company_name,email_address,email_password","urlw"=>"value1,value2,value3"],
    //sample 
    ...
    "dynamic_drop_down_array"=>['tag',"source","potential","stage","status","campaign"],
    ...
    "date_columns"=>['lead_date',"column_name2..."],
    ...
    "rename_cols_array"=>['url_name'=>'Setting Name',"url"=>"Setting value"],
    ...
    "new_label_buttons_arr"=>['leads_list'=>'plus-circle:New Lead : Lead profile / {{name}}'],
    //sample 
